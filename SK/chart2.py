...
file_paths = ["cc1.csv", "cc2.csv", "cc3.csv", "cc4.csv", "cc5.csv", "cc6.csv", "cc7.csv", "cc8.csv", "cc9.csv", "cc10.csv"]
...
plt.plot(aggregated_data["tick"], aggregated_data["undecided"], label="Undecided", marker="o")
...
plt.figure(figsize=(10, 6))
plt.plot(aggregated_data["tick"], aggregated_data["polarization-index"], marker="o", color="purple")
plt.xlabel("Time (ticks)")
...
plt.figure(figsize=(10, 6))
plt.bar(aggregated_data["tick"], aggregated_data["total-opinion-changes"], color="orange")
plt.xlabel("Time (ticks)")
...
plt.figure(figsize=(10, 6))
plt.errorbar(aggregated_data["tick"], aggregated_data["left"], yerr=std_data["left"], label="Left", marker="o", capsize=5)
plt.xlabel("Time (ticks)")
plt.ylabel("Percentage of Agents")
